...
# $4 = STARSPOD=POD
# ex: sh setup_kirabackend.sh 'uscloudprod.us.deloitte.com' 'USAZUAUDDE' 'Quality Assurance' 'POD'
##########################################################################
...
#######################
logdir="/mnt/resource"
logfile="setup_kirabackend.log"
puppetinstalllogfile="puppet_install.log"
lckfile=".setup_kirabackend.lck"
vgname="vgdata01"
kiralv="kiralv"
kiramnt="/opt/kira"
...
function partitionDisk {
	...
	#update fstab
	logit "partitionDisk: Updating fstab."
