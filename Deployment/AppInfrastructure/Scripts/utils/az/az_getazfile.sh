...
#az storage file download -s arguspkgs -p pkgs/createkira/kira-r45_11/2018-10-24-r50.7-new-file-version.tar --account-name ameargusrpmrepo --account-key {KEY} --dest 2018-10-24-r50.7-new-file-version.tar
